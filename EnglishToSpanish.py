...
def get_sentence(filename):
	iam_apikey_s2t="ndg8DSSp9C7cpcYwsm3MN8vYh6HG63PS_uz04QgemZ8S"

	url_s2t="https://api.eu-gb.speech-to-text.watson.cloud.ibm.com/instances/d7c09d03-1ca5-45ee-bcbf-7b94535d10e9"
...
def translate_sentence(recognized_sentence):
	...
	apikey_lt="Fi9Qc2ku1BOQTv9MdwrH7WgsMIllekZNHiT8yUyH4X6P"

	url_lt="https://api.eu-gb.language-translator.watson.cloud.ibm.com/instances/769057ee-7d35-476e-af5b-aed790b4c52a"
